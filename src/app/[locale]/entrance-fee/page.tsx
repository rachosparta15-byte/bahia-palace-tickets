...
const COPY: Record<string, Copy> = {
  en: {
    ...
    cardSkip: 'Skip-the-Line', cardSkipSub: 'Same as gate price — no fee added', cardSkipNote: 'No ticket-office queue',
    ...
    rowSkip: 'Skip-the-Line (online)', rowSkipNote: 'No fee added — same as gate price',
  ...
  fr: {
    ...
    cardSkip: 'Coupe-file', cardSkipSub: 'Même prix qu’au guichet — sans frais ajoutés', cardSkipNote: 'Sans file au guichet',
    ...
    rowSkip: 'Coupe-file (en ligne)', rowSkipNote: 'Sans frais ajoutés — même prix qu’au guichet',
    ...
    feeA: `Non. Les billets coupe-file sont au même prix que les ${OFFICIAL_DOOR_PRICE_MAD} MAD du guichet — nous n'ajoutons aucun frais de réservation. Les visites guidées et privées coûtent plus cher car elles incluent un guide professionnel anglophone. Nous sommes un site d'information indépendant et sans affiliation : en continuant, vous finalisez votre achat directement sur le portail officiel du ministère de la Culture, et non chez nous.`,
  ...
  es: {
    ...
    cardSkip: 'Sin colas', cardSkipSub: 'Mismo precio que en taquilla — sin recargo', cardSkipNote: 'Sin cola en la taquilla',
    ...
    rowSkip: 'Sin colas (en línea)', rowSkipNote: 'Sin recargo — mismo precio que en taquilla',
    ...
    feeA: `No. Las entradas sin colas cuestan lo mismo que los ${OFFICIAL_DOOR_PRICE_MAD} MAD de taquilla: no añadimos ningún recargo. Las visitas guiadas y privadas cuestan más porque incluyen un guía profesional de habla inglesa. Somos un sitio informativo independiente y sin afiliación: al continuar, completarás tu compra directamente en el portal oficial del Ministerio de Cultura, no con nosotros.`,
  ...
  de: {
    ...
    cardSkip: 'Skip-the-Line', cardSkipSub: 'Gleicher Preis wie an der Kasse — ohne Aufschlag', cardSkipNote: 'Keine Schlange am Ticketschalter',
    ...
    rowSkip: 'Skip-the-Line (online)', rowSkipNote: 'Kein Aufschlag — gleicher Preis wie an der Kasse',
    ...
    feeA: `Nein. Skip-the-Line-Tickets kosten genauso viel wie die ${OFFICIAL_DOOR_PRICE_MAD} MAD an der Kasse — wir erheben keine Buchungsgebühr. Führungen und private Touren kosten mehr, weil ein professioneller englischsprachiger Guide enthalten ist. Wir sind eine unabhängige, nicht angeschlossene Informationsseite: Wenn Sie fortfahren, schließen Sie den Kauf direkt auf dem offiziellen Portal des Kulturministeriums ab, nicht bei uns.`,
  ...
  it: {
    ...
    cardSkip: 'Salta-fila', cardSkipSub: 'Stesso prezzo della biglietteria — nessun sovrapprezzo', cardSkipNote: 'Nessuna fila alla biglietteria',
    ...
    rowSkip: 'Salta-fila (online)', rowSkipNote: 'Nessun sovrapprezzo — stesso prezzo della biglietteria',
    ...
    feeA: `No. I biglietti salta-fila costano quanto i ${OFFICIAL_DOOR_PRICE_MAD} MAD della biglietteria: non aggiungiamo alcun costo di prenotazione. Le visite guidate e private costano di più perché includono una guida professionista di lingua inglese. Siamo un sito informativo indipendente e non affiliato: proseguendo, completerai l'acquisto direttamente sul portale ufficiale del Ministero della Cultura, non con noi.`,
  ...
  ar: {
    ...
    cardSkip: 'تخطّي الطابور', cardSkipSub: 'نفس ثمن الشبّاك — بلا رسوم إضافية', cardSkipNote: 'بلا طابور عند شبّاك التذاكر',
    ...
    rowSkip: 'تخطّي الطابور (عبر الإنترنت)', rowSkipNote: 'بلا رسوم إضافية — نفس ثمن الشبّاك',
    ...
    feeA: `لا. تذاكر تخطّي الطابور بنفس ثمن الشبّاك البالغ ${OFFICIAL_DOOR_PRICE_MAD} درهم — ولا نضيف أي رسوم حجز. أمّا الجولات المرشدة والخاصة فأغلى لأنها تشمل مرشدًا محترفًا ناطقًا بالإنجليزية. نحن موقع معلومات مستقلّ وغير تابع لأي جهة: عند المتابعة ستُتمّ الشراء مباشرةً على البوابة الرسمية لوزارة الثقافة، وليس عندنا.`,
  ...
  pt: {
    ...
    cardSkip: 'Sem fila', cardSkipSub: 'Mesmo preço da bilheteira — sem taxa adicional', cardSkipNote: 'Sem fila na bilheteira',
    ...
    rowSkip: 'Sem fila (online)', rowSkipNote: 'Sem taxa adicional — mesmo preço da bilheteira',
    ...
    feeA: `Não. Os bilhetes sem fila custam o mesmo que os ${OFFICIAL_DOOR_PRICE_MAD} MAD da bilheteira — não acrescentamos qualquer taxa de reserva. As visitas guiadas e privadas custam mais porque incluem um guia profissional de língua inglesa. Somos um site de informação independente e sem afiliação: ao continuar, concluirá a compra diretamente no portal oficial do Ministério da Cultura, e não connosco.`,
