...
const COPY: Record<string, Copy> = {
  ...
  es: {
    ...
    feeA: `No añadimos nada al precio. La entrada sin colas cuesta más que los ${OFFICIAL_DOOR_PRICE_MAD} MAD de taquilla porque no es el mismo producto: entrada sin hacer cola, más una audioguía digital que conservas en el móvil. Ese precio es el de Viator, no un recargo nuestro. Las visitas guiadas y privadas cuestan más porque incluyen un guía profesional de habla inglesa. Somos un sitio informativo independiente y sin afiliación: al continuar completas la compra en Viator, no con nosotros, y siempre puedes comprar tú mismo la entrada simple en el portal del Ministerio de Cultura.`,
