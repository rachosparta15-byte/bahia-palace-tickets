...
const META: Record<string, { title: string; description: string; subtitle: string; inDepth: string; readGuide: string; bottomNote: string }> = {
  ...
  fr: { title: 'Sécurité Marrakech 2026 — Arnaques | Palais Bahia', description: 'Conseils de sécurité essentiels avant de visiter le Palais Bahia et Marrakech : arnaques courantes, faux guides, taxis, henné et bonnes pratiques de voyage.', subtitle: 'Conseils essentiels pour rester en sécurité et éviter les pièges touristiques à Marrakech', inDepth: 'Guides de sécurité approfondis', readGuide: 'Lire le guide', bottomNote: "Restez vigilant et profitez de votre visite au Palais Bahia. En cas de doute, demandez au personnel officiel." },
  ...
  de: { title: 'Sicherheit Marrakesch 2026 — Betrug | Bahia Palast', description: 'Wichtige Sicherheitstipps für Touristen beim Besuch des Bahia Palasts und Marrakesch: Betrug vermeiden, Falschführer erkennen, Taxipreise und Henna-Fallen.', subtitle: 'Wesentliche Tipps, um sicher zu bleiben und Touristenfallen in Marrakesch zu vermeiden', inDepth: 'Ausführliche Sicherheitsratgeber', readGuide: 'Ratgeber lesen', bottomNote: 'Bleiben Sie wachsam und genießen Sie Ihren Besuch im Bahia Palast. Im Zweifelsfall wenden Sie sich an das Personal.' },
