    ...
    <div className="min-h-screen bg-[#1C1108]">
      ...
      <div className="relative h-72 md:h-96">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#1C1108]/85" />
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
        ...
        <section className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <div className="w-10 h-10 bg-[#C4452D]/15 rounded-xl flex items-center justify-center mb-4">
            ...
            <p className="text-[#C4A882] leading-relaxed text-lg">{t('missionBody')}</p>
          </div>
        ...
        <section className="bg-[#251A0F] rounded-2xl border border-[rgba(232,163,61,0.13)] p-8 md:p-10">
          <div className="w-10 h-10 bg-[#3B65C8]/15 rounded-xl flex items-center justify-center mb-4">
            <Globe size={20} className="text-[#3B65C8]" />
          </div>
          <h2 style={{ fontFamily: 'Cormorant Garamond, serif' }} className="text-2xl font-bold text-[#F5E8CC] mb-6">
            {t('whyTitle')}
          </h2>
          <ul className="space-y-4">
            {provideItems.map((item, i) => (
              <li key={i} className="flex items-start gap-3">
                <CheckCircle2 size={18} className="text-[#8FA63C] shrink-0 mt-0.5" />
                <span className="text-[#C4A882] leading-relaxed">{item}</span>
              </li>
            ))}
          </ul>
        </section>
        ...
        {/* Important Notice */}
        <section className="bg-[#E8A33D]/08 border-2 border-[#E8A33D]/30 rounded-2xl p-8 md:p-10">
          <div className="w-10 h-10 bg-[#E8A33D]/12 rounded-xl flex items-center justify-center mb-4">
            <AlertTriangle size={20} className="text-[#E8A33D]" />
          </div>
          <h2 style={{ fontFamily: 'Cormorant Garamond, serif' }} className="text-2xl font-bold text-[#F5E8CC] mb-4">
            {t('teamTitle')}
          </h2>
        ...
        <section className="bg-[#251A0F] border border-[rgba(232,163,61,0.15)] text-white rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            ...
            <p className="text-[#C4A882] leading-relaxed text-sm">{t('ctaBody')}</p>
          </div>
          <Link
            href="/contact"
