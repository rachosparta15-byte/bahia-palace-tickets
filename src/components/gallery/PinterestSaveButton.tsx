...
export function PinterestSaveButton({ pageUrl, imageUrl, description, className = '' }: Props) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-1 bg-[#E60023] hover:bg-[#cc001f] text-white text-[10px] font-bold leading-none px-2 py-1.5 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200 ${className}`}
    >
